...
function doTweaks() {
  ...
  var taskButton = document.querySelector('.TopbarPageHeaderGlobalActions-omnibutton');
  ...
  /*
   * Use only a plus sign in the "new task" button
   */
  taskButton.innerHTML = '<svg class="MiniIcon PlusMiniIcon Omnibutton-plusIcon" viewBox="0 0 24 24"><path d="M10,10V4c0-1.1,0.9-2,2-2c1.1,0,2,0.9,2,2v6h6c1.1,0,2,0.9,2,2c0,1.1-0.9,2-2,2h-6v6c0,1.1-0.9,2-2,2c-1.1,0-2-0.9-2-2v-6H4c-1.1,0-2-0.9-2-2c0-1.1,0.9-2,2-2H10z"></path></svg>';
